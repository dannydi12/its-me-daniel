...
function Contact() {
  ...
  const handleClick = () => {
    ...
    if (!danielGotScared) {
      ...
      fetch('https://maker.ifttt.com/trigger/scare_daniel/with/key/clUSpcWoAOP3U6Dv-WatQS_rwJiOdf7uaH3Rv1bAWeG', {
        method: 'POST',
        mode: 'no-cors',
      })
  ...
  return (
    <section className="contact-section">
      <div className="section-wrapper">
        ...
        <p>
          If traditional methods of communication aren't your thing, click the button
          and it will turn on the custom LED server I installed in my room.
          It's pretty jarring, and I'll just think it's the robot uprising.
        </p>
        <button
          type="button"
          onClick={() => {
