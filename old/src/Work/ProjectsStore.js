const STORE = [
  {
    ...
    category: ['Other'],
    description: 'Seeking a new project and an excuse to exercise my design chops, I built and designed an artist profile page for someone I\'ve known for some time.',
  ...
  },
  {
    ...
    category: ['Featured'],
    description: 'Are you feeling down? Fix all of life\'s problems with a daily piece of advice. Automatically generated by a bot, as all things should be.',
    image: '/images/emotional-support-bot.png',
    languages: ['React', 'HTML', 'CSS', 'Typescript', 'Node', 'Firebase', 'Sendgrid', 'Sadness'],
    live: 'https://emotionalsupportbot.com',
  },
  {
    title: 'Crosswalk App',
    category: ['Featured'],
    description: 'Your gateway into the unseen world around you. Drop & discover hidden messages wherever you find yourself.',
    image: '/images/crosswalk.png',
    languages: ['React', 'CapacitorJS', 'HTML', 'CSS', 'Typescript', 'Node', 'MongoDB'],
